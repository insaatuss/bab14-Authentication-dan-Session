				...
				<div class="col col-8 p-4 bg-light">
					...
					<form method="POST" action="action_register.php">
						...
						<div class="form-group mb-2">
							...
							<input type="text" id="name" class="form-control" name="name" placeholder="Masukkan Nama Lengkap" required>
						</div>
						...
						<div class="form-group mb-2">
							...
							<input type="password" id="re-password" class="form-control" name="re-password" placeholder="Ulangi Password" required>
						</div>
